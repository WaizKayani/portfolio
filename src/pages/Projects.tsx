    ...
    <div id="projects" className="min-h-screen py-16 bg-netflix-black flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, idx) => (
          <motion.div
            key={project.title}
            className="netflix-card flex flex-col h-full justify-between shadow-lg hover:shadow-2xl transition-shadow duration-300"
          ...
          >
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((tech) => (
                  <span key={tech.name} className="flex items-center gap-1 bg-netflix-dark-gray text-white px-3 py-1 rounded-full text-xs font-medium">
            ...
            <div className="mt-auto pt-2">
              <a href={project.github} target="_blank" rel="noopener noreferrer" className="netflix-button flex items-center justify-center gap-2 w-full">
